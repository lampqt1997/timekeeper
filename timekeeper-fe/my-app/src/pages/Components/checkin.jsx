    ...
    render() { 
        return (                    
            ...
            <div class="filter-table col-12">
                ...
                <div class="row  my-4">
                    <div class="col-auto">
                        <label for="phban" class="text-dark h4 mt-0">Phòng ban</label>
                    </div>
                    <div class="col-3">
                        <div class="form-group">
                            <input id="phban" class="form-control" type="text" name="inlineRadioOptions"/>
                        </div>
                    </div>
